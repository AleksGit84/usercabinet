...
<div id="wrap">
    <div id="header"></div>
    <div id="auth">
        <!--<div style="padding: 0 100px 40px 100px; color: red; text-align:center; font-size: 21px;">Èçâèíèòå, ëè÷íûé êàáèíåò â äàííûé ìîìåíò íå äîñòóïåí.</div>-->
        <div class="login">
            <form action="scripts/auth.php" method="post">
                <table>
                    ...
                    <tr>
                        <td class="submit"><input type="submit" value="Âîéòè" /><input type="hidden" name="cmd" value="user_verify" /></td>
                    </tr>
                </table>
            </form>
